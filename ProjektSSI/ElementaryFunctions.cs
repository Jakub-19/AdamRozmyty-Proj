...
namespace ProjektSSI
{
    ...
    {
        public static uint P {get;set;}
        //Proporcja()
        static public double Proportion(uint blackValue, uint whiteValue) //funkcja zwracająca obliczoną wartość odczytu
        {
            return 100 / (whiteValue - blackValue);
        }
        //Odczyt()
